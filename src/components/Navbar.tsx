...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 flex justify-between items-center border-b md:h-[10vh] h-[7vh] px-5 bg-white z-10">
      ...
      <label
        htmlFor="search"
        className="hidden md:flex items-center border border-gray-300 bg-gray-100 rounded-full w-[40%] px-3 "
      >
        ...
        <input
          ...
          id="search"
          className="w-full bg-transparent border-transparent focus:border-transparent focus:ring-0"
        />
      </label>
        ...
        {searchResults?.length > 0 && searchResults[0] !== 0 && (
          <div className="w-[250px] max-h-[200px] overflow-y-scroll scrollbar-none py-2 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded">
            {searchResults.map((e, i) => (
              <div key={i}>
                <div
                  className="flex items-center gap-3 hover:bg-gray-100 cursor-pointer px-2 py-1"
                  onClick={() => {
                    setSearch("");
      ...
      <div className="md:hidden">
        ...
        >
          ...
          <span
            ...
            className="flex items-center gap-2 px-5 py-3 rounded-lg cursor-pointer text-[#0381ec] border hover:bg-gray-200 mb-14"
          >
            <LogOut />
            Logout
          </span>
